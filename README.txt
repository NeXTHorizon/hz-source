...
seconds. When it is ready, you should see the message "HZ server 1.0.0 started
...
The HZ software is a client-server application. It consists of a java server
...
The default HZ client does not store any wallet-type file on disk. Unlike
