...
public interface Appendix {
    ...
    static abstract class AbstractAppendix implements Appendix {
        ...
        AbstractAppendix() {
            ...
            this.version = (byte)(Nhz.getBlockchain().getHeight() < Constants.TRANSACTIONS_VERSION_1_BLOCK ? 0 : 1);
        }
        ...
        abstract void validate(Transaction transaction) throws NhzException.ValidationException;
    ...
    public static class Message extends AbstractAppendix {
        ...
        static Message parse(JSONObject attachmentData) throws NhzException.NotValidException {
        ...
        Message(ByteBuffer buffer, byte transactionVersion) throws NhzException.NotValidException {
            ...
            if (messageLength > Constants.MAX_ARBITRARY_MESSAGE_LENGTH) {
                throw new NhzException.NotValidException("Invalid arbitrary message length: " + messageLength);
            }
            this.message = new byte[messageLength];
            buffer.get(this.message);
        }

        Message(JSONObject attachmentData) throws NhzException.NotValidException {
        ...
        @Override
        void validate(Transaction transaction) throws NhzException.ValidationException {
            if (this.isText && transaction.getVersion() == 0) {
                throw new NhzException.NotValidException("Text messages not yet enabled");
            }
            if (transaction.getVersion() == 0 && transaction.getAttachment() != Attachment.ARBITRARY_MESSAGE) {
                throw new NhzException.NotValidException("Message attachments not enabled for version 0 transactions");
            }
            if (message.length > Constants.MAX_ARBITRARY_MESSAGE_LENGTH) {
                throw new NhzException.NotValidException("Invalid arbitrary message length: " + message.length);
            }
        }
    ...
    abstract static class AbstractEncryptedMessage extends AbstractAppendix {
        ...
        private AbstractEncryptedMessage(ByteBuffer buffer, byte transactionVersion) throws NhzException.NotValidException {
            super(buffer, transactionVersion);
        ...
        private AbstractEncryptedMessage(JSONObject attachmentJSON, JSONObject encryptedMessageJSON) throws NhzException.NotValidException {
        ...
        void validate(Transaction transaction) throws NhzException.ValidationException {
            if (encryptedData.getData().length > Constants.MAX_ENCRYPTED_MESSAGE_LENGTH) {
                throw new NhzException.NotValidException("Max encrypted message length exceeded");
            }
            if ((encryptedData.getNonce().length != 32 && encryptedData.getData().length > 0)
                ...
                throw new NhzException.NotValidException("Invalid nonce length " + encryptedData.getNonce().length);
            }
        }
    ...
    public static class EncryptedMessage extends AbstractEncryptedMessage {
        ...
        static EncryptedMessage parse(JSONObject attachmentData) throws NhzException.NotValidException {
        ...
        EncryptedMessage(ByteBuffer buffer, byte transactionVersion) throws NhzException.ValidationException {
            super(buffer, transactionVersion);
        }

        EncryptedMessage(JSONObject attachmentData) throws NhzException.NotValidException {
        ...
        void validate(Transaction transaction) throws NhzException.ValidationException {
            ...
            if (! transaction.getType().hasRecipient()) {
                throw new NhzException.NotValidException("Encrypted messages cannot be attached to transactions with no recipient");
            }
            if (transaction.getVersion() == 0) {
                throw new NhzException.NotValidException("Encrypted message attachments not enabled for version 0 transactions");
            }
        }
    ...
    public static class EncryptToSelfMessage extends AbstractEncryptedMessage {
        ...
        static EncryptToSelfMessage parse(JSONObject attachmentData) throws NhzException.NotValidException {
        ...
        EncryptToSelfMessage(ByteBuffer buffer, byte transactionVersion) throws NhzException.ValidationException {
            super(buffer, transactionVersion);
        }

        EncryptToSelfMessage(JSONObject attachmentData) throws NhzException.NotValidException {
        ...
        void validate(Transaction transaction) throws NhzException.ValidationException {
            super.validate(transaction);
            if (transaction.getVersion() == 0) {
                throw new NhzException.NotValidException("Encrypt-to-self message attachments not enabled for version 0 transactions");
            }
        }
    ...
    public static class PublicKeyAnnouncement extends AbstractAppendix {
        ...
        static PublicKeyAnnouncement parse(JSONObject attachmentData) throws NhzException.NotValidException {
        ...
        PublicKeyAnnouncement(JSONObject attachmentData) throws NhzException.NotValidException {
            super(attachmentData);
        ...
        void validate(Transaction transaction) throws NhzException.ValidationException {
            if (! transaction.getType().hasRecipient()) {
                throw new NhzException.NotValidException("PublicKeyAnnouncement cannot be attached to transactions with no recipient");
            }
            if (publicKey.length != 32) {
                throw new NhzException.NotValidException("Invalid recipient public key length: " + Convert.toHexString(publicKey));
            }
            Long recipientId = transaction.getRecipientId();
            if (! Account.getId(this.publicKey).equals(recipientId)) {
                throw new NhzException.NotValidException("Announced public key does not match recipient accountId");
            }
            if (transaction.getVersion() == 0) {
                throw new NhzException.NotValidException("Public key announcements not enabled for version 0 transactions");
            }
            ...
            if (recipientAccount != null && recipientAccount.getPublicKey() != null && ! Arrays.equals(publicKey, recipientAccount.getPublicKey())) {
                throw new NhzException.NotCurrentlyValidException("A different public key for this account has already been announced");
            }
        }
